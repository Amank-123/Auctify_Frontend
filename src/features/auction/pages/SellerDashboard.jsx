...
function OrderSkeleton() {
    return (
        <div className="bg-white rounded-2xl border border-stone-100 p-5 flex gap-4">
        ...
        >
            ...
            <div>
                ...
                {loading ? (
                    ...
                    <p className="text-[28px] font-black text-stone-900 leading-none mt-0.5">
                        {value}
                    </p>
                )}
            </div>
...
function InfoRow({ icon: Icon, label, value }) {
    return (
        <div className="flex flex-col gap-0.5 min-w-0">
            <span className="text-[10px] uppercase tracking-widest text-stone-400 font-bold flex items-center gap-1">
        ...
        >
                            ...
                            onError={(e) => {
                                e.target.replaceWith(
                                    Object.assign(document.createElement("div"), {
                                        className:
                                            "w-24 h-24 rounded-xl bg-stone-100 flex items-center justify-center",
                                    }),
                                );
                            }}
                        />
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                            <h2 className="text-[15px] font-bold text-stone-900 leading-snug truncate">
                                {order?.auctionId?.name || "Untitled Auction"}
                            </h2>
                            <p className="text-[12px] text-stone-400 mt-0.5 flex items-center gap-1">
                                <User2 size={10} />
                                {buyerName}
                            </p>
                        </div>
                    ...
                    <div className="flex items-center gap-2 mt-4 flex-wrap">
                        {canSendOTP && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 text-[12px] font-semibold px-3.5 py-2 rounded-xl transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
                                style={{
                        ...
                        {!delivered && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 text-[12px] font-semibold px-3.5 py-2 rounded-xl border transition-all duration-200"
                                style={{
                                    background: "#f0fdf4",
                                    color: "#15803d",
                        ...
                        {delivered && (
                            <span
                                className="inline-flex items-center gap-1.5 text-[12px] font-semibold px-3.5 py-2 rounded-xl"
                                style={{
                                    background: "#ecfdf5",
                                    color: "#065f46",
                        ...
                        <button
                            ...
                            className="ml-auto inline-flex items-center gap-1 text-[12px] text-stone-400 hover:text-stone-700 font-medium transition-colors"
                        >
                            <Eye size={12} />
            ...
            <AnimatePresence initial={false}>
                {expanded && (
                    ...
                    >
                        <div
                            className="mx-5 mb-5 pt-4 border-t grid grid-cols-2 sm:grid-cols-3 gap-4"
            ...
            >
                ...
                <div className="space-y-3">
                    <input
                        ...
                        maxLength={6}
                        autoFocus
                        className="w-full rounded-xl border px-4 py-3.5 text-xl font-bold text-stone-900 tracking-[0.35em] text-center transition-colors focus:outline-none"
                        style={{
                    ...
                    <button
                        ...
                        disabled={verifying}
                        className="w-full py-3.5 rounded-xl font-bold text-[13px] text-white flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-70"
                    ...
                    <button
                        onClick={onClose}
                        className="w-full py-3 rounded-xl text-[13px] font-medium text-stone-500 hover:text-stone-700 hover:bg-stone-50 transition-colors"
                    >
                        Cancel
                    </button>
                </div>
...
export default function SellerDashboard() {
    ...
    return (
        <div
            className="min-h-screen px-4 sm:px-6 lg:px-10 py-8 sm:py-10"
        ...
        >
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div>
                        <h1 className="text-2xl sm:text-[28px] font-black text-stone-900 tracking-tight">
                            Seller Orders
                        </h1>
                    ...
                    <Link to="/auction/create">
                        <motion.span
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="inline-flex items-center gap-2 text-[13px] font-semibold px-4 py-2.5 rounded-xl transition-all cursor-pointer"
                            style={{
                                background: "#1c1917",
                                color: "#fafaf9",
                            }}
                ...
                >
                    <div className="relative flex-1">
                        <Search
                            size={14}
                            className="absolute top-1/2 left-3.5 -translate-y-1/2 text-stone-300 pointer-events-none"
                        />
                        <input
                            type="text"
                            placeholder="Search auction or buyer name…"
                            value={search}
                            onChange={(e) => setSearch(e.target.value)}
                            className="w-full bg-white border rounded-xl pl-9 pr-4 py-2.5 text-[13px] text-stone-800 placeholder-stone-300 focus:outline-none focus:border-stone-300 transition-colors"
                            style={{
                    ...
                    >
                        {FILTERS.map(({ key, label, icon: Icon }) => (
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-[12px] font-semibold transition-all duration-200"
                                style={
                                    filter === key
                ...
                <div className="flex flex-col gap-3">
                    {loading ? (
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl border p-20 text-center"
                            style={{ border: "1px solid #f5f5f4" }}
                        >
                            ...
                            <h3 className="text-[16px] font-bold text-stone-700">
                                No orders found
                            </h3>
                            <p className="text-[13px] text-stone-400 mt-1">
                                {search
