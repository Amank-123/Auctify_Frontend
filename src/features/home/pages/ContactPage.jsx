...
import { Mail, Phone, MapPin, Clock, Send, MessageCircle, ShieldCheck } from "lucide-react";
            ...
            <section className="border-b border-[#E5E7EB] bg-white">
                <div className="max-w-7xl mx-auto px-6 py-16">
                    ...
                    >
                        ...
                        <h1 className="text-5xl font-bold tracking-tight mt-5">Contact Us</h1>

                        <p className="text-[#6B7280] text-lg mt-3 max-w-2xl">
                            Need help with auctions, bidding, payments, or your account? Reach out
                            and our support team will get back to you quickly.
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6">
                            ...
                            <p className="text-[#6B7280] mt-2 text-sm leading-6">
                                Send us your issue anytime and we'll respond as soon as possible.
                            </p>
