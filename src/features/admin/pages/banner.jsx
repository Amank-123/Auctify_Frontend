...
import { Plus, Pencil, Trash2, Loader2, ImagePlus, Check, X } from "lucide-react";
...
const BannerPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingBanner) {
                const res = await api.put(`/api/banner/${editingBanner}`, formData, {
                    headers: {
                    ...
                    <div>
                        {loading ? (
                            ...
                            <div className="bg-white border border-dashed border-slate-300 rounded-3xl h-[500px] flex flex-col items-center justify-center">
                                <h2 className="text-2xl font-bold text-slate-800">No banners</h2>

                                <p className="text-slate-500 mt-2">Create your first banner</p>
                            </div>
                        ) : (
