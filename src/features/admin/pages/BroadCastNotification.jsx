            ...
            >
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <Icon
                                                size={16}
                                                className={
                                                    isActive ? t.activeIcon : "text-slate-400"
                                                }
                                                strokeWidth={1.8}
                                            />
                                            <div>
                                                <p
                                                    className={`text-xs font-bold ${isActive ? t.activeText : "text-slate-600"}`}
                                                >
                                                    {t.label}
                                                </p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Field label="Upload Image">
                                    <div className="space-y-3">
                                        <label
                                            className={`w-full flex flex-col items-center justify-center rounded-2xl border-2 border-dashed transition-all cursor-pointer overflow-hidden ${
                                                formData.image
                                            ...
                                            {formData.image ? (
                                                <div className="relative w-full">
                                                    ...
                                                    <div className="absolute inset-0 bg-black/0 hover:bg-black/30 transition flex items-center justify-center">
                                                        <span className="opacity-0 hover:opacity-100 text-white text-sm font-semibold transition">
                                                            Change Image
                                                        </span>
                                                    </div>
                                                </div>
                ...
                <AnimatePresence>
                    {formData.title && (
                        ...
                        >
                            <div
                                className={`w-8 h-8 rounded-xl ${activeType.activeBg} flex items-center justify-center flex-shrink-0 ring-1 ${activeType.activeBorder}`}
                            >
                                {(() => {
                                    const Icon = activeType.icon;
                                    return <Icon size={14} className={activeType.activeIcon} />;
                                })()}
                            </div>
                            <div className="min-w-0">
                                <div className="flex items-center gap-2 mb-0.5">
                                    <p className="text-xs font-bold text-slate-800 truncate">
                                        {formData.title || "Notification preview"}
                                    </p>
                                    <span
                                        className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full flex-shrink-0 ${activeType.activeBg} ${activeType.activeText}`}
                                    >
                                        {activeType.label}
                                    </span>
                                </div>
